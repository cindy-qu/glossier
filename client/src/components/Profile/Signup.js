...
const Signup = ({ setUser }) => {
  ...
  return (
    <div className="font-apercu text-md">
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <img src={GFLogo} className="w-10 h-10 mx-auto rounded-full" alt="Glossier Fanatics Logo"/>

                <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-purple-font">Join Glossier Fanatics</h2>
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button type="submit" className="flex w-full justify-center rounded-md bg-red-300 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign up</button>
                    </div>
                </form>
                <ul>{formErrorMsg}</ul>
                <p className="mt-10 text-center text-sm text-gray-500">
                    Have an account?
                <a href="/login" className="font-semibold leading-6 text-red-500 hover:text-red-400"> Log in here!</a>
                </p>
            </div>
        </div>
    </div>
